    ...
    <section id='overview' className="bg-gray-100 dark:bg-gray-900 py-20">
      <div className="container mx-auto px-6">
        <h2 className="text-4xl font-bold text-center text-gray-800 dark:text-white mb-8">
          Welcome to Select Maid
        </h2>
        <p className="text-center text-lg text-gray-600 dark:text-gray-300 mb-8">
        Welcome to Select Maid! We're dedicated to transforming your space with top-notch cleaning services. Whether it's for your home or office, trust us for reliability, quality, and a commitment to exceeding your cleanliness expectations.
        </p>
